...
#        assert(lambd==0 or keep_prob==1)    # it is possible to use both L2 regularization and dropout, 
        ...
        if lambd == 0 and keep_prob == 1:
            ...
            grads = backward_propagation_with_regularization_dropout(X, Y, cache, lambd, keep_prob)
        elif lambd != 0:
...
# GRADED FUNCTION: backward_propagation_with_regularization_dropout

def backward_propagation_with_regularization_dropout(X, Y, cache, lambd, keep_prob):
    """
    Implements the backward propagation of our baseline model to which we added dropout.
